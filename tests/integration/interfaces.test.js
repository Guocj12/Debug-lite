...
test('IF-1 T-DC-8：decisions.md 每条 D-编号在 interfaces.md 有落点（整词匹配）', () => {
  ...
  // D-137..D-153、D-154..D-157、D-158、D-159..D-163、D-164..D-167），共 119 条（2026-09-16：P7 冲刺组 D-137..D-153 共 17 条；
  ...
  assert.equal(decided.size, 119, `D 编号数量应为 119（decisions.md 无跳段之外的编号）`);
});
