...
test('IF-1 T-DC-8：decisions.md 每条 D-编号在 interfaces.md 有落点（整词匹配）', () => {
  ...
  // D-137..D-153、D-154..D-157），共 109 条（2026-09-16：P7 冲刺组 D-137..D-153 共 17 条；
  //   2026-09-19：P7 收口补充 D-154..D-157 共 4 条——本次中央文档批追加）
  assert.equal(decided.size, 109, `D 编号数量应为 109（decisions.md 无跳段之外的编号）`);
});
