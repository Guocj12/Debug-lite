...
> 版本：v1　创建：2026-09-12　更新基线：**2026-09-19 复核（后端 P0–P5 共 34 批 + P7/B27–B33 共 7 批已收口；`npm test` = 903 通过 / 0 失败；`npm run gate` = 9 PASS / 0 FAIL / 0 PEND；`npm run check:docs` PASS）**
...
```bash
npm test        # node --test --test-isolation=none tests/**/*.test.js（沙箱下必须单进程）→ 2026-09-19 实测 903 通过 / 0 失败
